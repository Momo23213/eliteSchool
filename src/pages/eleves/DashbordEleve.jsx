...
const DashbordEleve = () => {
  ...
  return (
    <div className="min-h-screen mt-15 md:mt-11 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 pt-20">

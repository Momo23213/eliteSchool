...
const DashbordEnseignant = () => {
  ...
  return (
    <div className="min-h-screen mt-15 md:mt-11 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-gray-900 dark:via-emerald-900 dark:to-teal-900 pt-20">
